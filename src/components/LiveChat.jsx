...
const LiveChat = () => {
  ...
  const [messages, setMessages] = useState([
    { 
      id: 1, 
      text: "Hello! Welcome to Parekh e-Trade. How can I assist you today?", 
      sender: 'bot' 
    }
  ]);
  ...
  const whatsappMessage = "Hello Parekh e-Trade, I would like to make an enquiry.";
  ...
  const handleSend = (e) => {
    ...
    setTimeout(() => {
      const botMsg = { 
        id: Date.now() + 1, 
        text: "Thank you! Our authorized representative will contact you shortly.", 
        sender: 'bot' 
      };
